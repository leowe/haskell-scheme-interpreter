...
module SchemeEvaluator (evalString, primitiveBindings, eval, runIOThrows, bindVars) where
...
eval env (List (function : args)) = do
     ...
     apply func argVals
eval env l@(List contents) = return l
eval env l@(DottedList _ _) = return l
